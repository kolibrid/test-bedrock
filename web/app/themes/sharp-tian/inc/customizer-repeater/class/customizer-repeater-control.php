...
class Customizer_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'sharp-tian-customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/inc/customizer-repeater/js/fontawesome-iconpicker.min.css', array(), 999 );
	}
