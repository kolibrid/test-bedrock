...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var twitter = jQuery(this).find('.customizer-repeater-twitter-control').val();
            var facebook = jQuery(this).find('.customizer-repeater-facebook-control').val();
            var instagram = jQuery(this).find('.customizer-repeater-instagram-control').val();
            var linkedin = jQuery(this).find('.customizer-repeater-linkedin-control').val();
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if(parentid == 'customize-control-featuredimage_slider')
        {   
            var numItems = jQuery("#customize-control-featuredimage_slider .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 1){
              jQuery( "#customize-control-featuredimage_slider_pro .customize-upgrade-pro-message" ).show();
              return false;   
            }
        }
        
        
        if(parentid == 'customize-control-featured_section_content')
        {   
            var numItems = jQuery("#customize-control-featured_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){
        ...
        {   
            var numItems = jQuery("#customize-control-about_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 4){
        ...
        if(parentid == 'customize-control-our_portfolio_section_content')
        {   
            var numItems = jQuery("#customize-control-our_portfolio_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){
        ...
        {   
            var numItems = jQuery("#customize-control-our_services_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){
        ...
        if(parentid == 'customize-control-our_testimonial_section_content')
        {   
            var numItems = jQuery("#customize-control-our_testimonial_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){
        ...
        if(parentid == 'customize-control-our_sponsors_section_content')
        {   
            var numItems = jQuery("#customize-control-our_sponsors_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 5){
        ...
        if(parentid == 'customize-control-our_team_section_content')
        {   
            var numItems = jQuery("#customize-control-our_team_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 4){
        ...
        if(parentid == 'customize-control-social_icon_section_content')
        {   
            var numItems = jQuery("#customize-control-social_icon_section_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 4){
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                /*Remove value from link field*/
                field.find('.customizer-repeater-twitter-control').val('');

                /*Remove value from link field*/
                field.find('.customizer-repeater-facebook-control').val('');

                /*Remove value from link field*/
                field.find('.customizer-repeater-instagram-control').val('');

                /*Remove value from link field*/
                field.find('.customizer-repeater-linkedin-control').val('');
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                var main_slider_items = jQuery("#customize-control-featuredimage_slider .customizer-repeater-general-control-repeater-container").length 
                if(main_slider_items < 2){ 
                  jQuery( "#customize-control-featuredimage_slider_pro .customize-upgrade-pro-message" ).hide();
                }

                var featured_section_items = jQuery("#customize-control-featured_section_content .customizer-repeater-general-control-repeater-container").length 
                if(featured_section_items < 4){ 
                  jQuery( "#customize-control-featured_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var about_section_items = jQuery("#customize-control-about_section_content .customizer-repeater-general-control-repeater-container").length 
                if(about_section_items < 5){ 
                  jQuery( "#customize-control-about_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var our_portfolio_items = jQuery("#customize-control-our_portfolio_section_content .customizer-repeater-general-control-repeater-container").length 
                if(our_portfolio_items < 4){ 
                  jQuery( "#customize-control-our_portfolioin_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var services_section_items = jQuery("#customize-control-our_services_section_content .customizer-repeater-general-control-repeater-container").length 
                if(services_section_items < 4){ 
                  jQuery( "#customize-control-our_services_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var testimonial_section_items = jQuery("#customize-control-our_testimonial_section_content .customizer-repeater-general-control-repeater-container").length 
                if(testimonial_section_items < 4){ 
                  jQuery( "#customize-control-our_testimonial_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var sponsors_section_items = jQuery("#customize-control-our_sponsors_section_content .customizer-repeater-general-control-repeater-container").length 
                if(sponsors_section_items < 6){ 
                  jQuery( "#customize-control-our_sponsors_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var team_section_items = jQuery("#customize-control-our_team_section_content .customizer-repeater-general-control-repeater-container").length 
                if(team_section_items < 5){ 
                  jQuery( "#customize-control-our_team_section_pro .customize-upgrade-pro-message" ).hide();
                }

                var social_icon_items = jQuery("#customize-control-social_icon_section_content .customizer-repeater-general-control-repeater-container").length 
    ...
    theme_conrols.on('keyup', '.customizer-repeater-twitter-control', function () {
        customizer_repeater_refresh_general_control_values();
    });

    theme_conrols.on('keyup', '.customizer-repeater-facebook-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
    theme_conrols.on('keyup', '.customizer-repeater-instagram-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
    theme_conrols.on('keyup', '.customizer-repeater-linkedin-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
